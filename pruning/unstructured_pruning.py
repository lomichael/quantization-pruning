...
def apply_pruning(model, amount=0.5):
    logging.info("Applying unstructured pruning")
...
def main():
    ...
    logging.info(f"Total Inference Time after Pruning: {total_inference_time} seconds")
    logging.info(f"Inference Time per Batch after Pruning: {avg_batch_time} seconds")
